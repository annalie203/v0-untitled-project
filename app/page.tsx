...
import AcehPatterns from "./components/aceh-patterns"
    ...
    <div className="relative min-h-screen bg-[#f8f3e9] text-[#5a3e2b] overflow-x-hidden">
      ...
      <AnimatePresence>
        {!isOpen && (
          ...
          >
            <div className="absolute inset-0 bg-[url('/patterns/aceh-background-pattern.png')] opacity-10 pointer-events-none"></div>
            <motion.div
            ...
            >
              <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
                <div className="absolute top-0 left-0 w-full h-16 bg-[url('/patterns/aceh-pattern-top.png')] bg-repeat-x opacity-60"></div>
                <div className="absolute bottom-0 left-0 w-full h-16 bg-[url('/patterns/aceh-pattern-bottom.png')] bg-repeat-x opacity-60"></div>
                <div className="absolute left-0 top-0 h-full w-16 bg-[url('/patterns/aceh-pattern-left.png')] bg-repeat-y opacity-60"></div>
                <div className="absolute right-0 top-0 h-full w-16 bg-[url('/patterns/aceh-pattern-right.png')] bg-repeat-y opacity-60"></div>
              </div>
              ...
              >
                <span className="text-[#d4af37]">Jaroe Dua Blah Ateuh Jeumala</span>
              </motion.div>
              ...
              <motion.div
                ...
                className="mb-8"
              >
                <div className="inline-block p-4 border border-[#d4af37] rounded-lg bg-[#0c4a34]/50">
              ...
              <motion.button
                ...
                transition={{ delay: 1 }}
                onClick={handleOpen}
                className="px-8 py-3 text-[#0c4a34] bg-[#d4af37] rounded-full font-medium hover:bg-[#c9a633] transition-colors relative z-20 cursor-pointer"
              >
      ...
      <main className={cn("transition-opacity duration-1000", isOpen ? "opacity-100" : "opacity-0")}>
        ...
        <section className="relative min-h-screen flex flex-col items-center justify-center text-center p-6 overflow-hidden">
          <div className="absolute inset-0 z-0">
            ...
            <div className="absolute inset-0 bg-[url('/patterns/aceh-background-pattern.png')] opacity-5"></div>
          </div>
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <motion.p
              ...
              className="text-lg mb-8 text-[#d4af37] italic"
            >
        ...
        <section className="py-20 px-6 bg-white relative overflow-hidden">
          <AcehPatterns className="opacity-5" />
          <div className="max-w-3xl mx-auto text-center relative z-10">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="p-6 border border-[#d4af37]/30 rounded-lg bg-[#f8f3e9] relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-16 h-16 bg-[url('/patterns/aceh-corner.png')] bg-no-repeat bg-contain opacity-20"></div>
              ...
              <div className="p-6 border-2 border-[#d4af37]/30 rounded-lg bg-[#f8f3e9]/50 relative overflow-hidden mb-8">
                <div className="absolute top-0 left-0 w-full h-full bg-[url('/patterns/aceh-background-pattern.png')] opacity-5"></div>
                <p className="text-lg italic relative z-10">"Minal 'Aidin wal Faizin, Mohon Maaf Lahir dan Batin"</p>
                <p className="text-md mt-2 text-[#0c4a34]/80 relative z-10">
            ...
            >
              ...
              <div className="flex flex-col md:flex-row items-center justify-center gap-8">
                <div className="relative w-64 h-64 rounded-full overflow-hidden border-4 border-[#d4af37]">
                  ...
                  <div className="absolute inset-0 bg-[url('/patterns/aceh-circle-pattern.png')] bg-cover opacity-10"></div>
                </div>
        ...
        {/* Aceh Culture Section */}
        <section className="py-20 px-6 bg-[#0c4a34] text-white relative overflow-hidden">
          <div className="absolute inset-0 bg-[url('/patterns/aceh-background-pattern.png')] opacity-5"></div>
          <div className="max-w-3xl mx-auto relative z-10">
            ...
            >
              <div className="flex justify-center mb-6">
                <Image
                  src="/images/aceh-ornament-white.png"
                  alt="Aceh Ornament"
                  width={120}
                  height={40}
                  className="opacity-80"
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6 font-serif">Budaya Aceh</h2>
              <p className="text-lg max-w-2xl mx-auto mb-10">
                Aceh memiliki kekayaan budaya yang khas dan menjadi kebanggaan masyarakatnya
              </p>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-white/10 p-6 rounded-lg backdrop-blur-sm relative overflow-hidden group">
                  <div className="absolute top-0 right-0 w-20 h-20 bg-[url('/patterns/aceh-corner.png')] bg-no-repeat bg-contain opacity-20"></div>
                  <div className="relative z-10">
                    <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-[#d4af37]/20 flex items-center justify-center">
                      <Image src="/images/tari-saman-icon.png" alt="Tari Saman" width={40} height={40} />
                    </div>
                    <h3 className="text-xl font-bold mb-3">Tari Saman</h3>
                    <p className="text-white/80">
                      Tari Saman adalah tarian tradisional Aceh yang menampilkan gerakan tangan dan tepukan dada yang
                      harmonis dan kompak. Tarian ini telah diakui oleh UNESCO sebagai Warisan Budaya Tak Benda.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white/10 p-6 rounded-lg backdrop-blur-sm relative overflow-hidden group">
                  ...
                  <div className="relative z-10">
                    <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-[#d4af37]/20 flex items-center justify-center">
                      <Image src="/images/rumoh-aceh-icon.png" alt="Rumoh Aceh" width={40} height={40} />
                    </div>
                    <h3 className="text-xl font-bold mb-3">Rumoh Aceh</h3>
                    <p className="text-white/80">
                      Rumoh Aceh adalah rumah tradisional Aceh yang dibangun dengan konsep panggung. Rumah ini memiliki
                      filosofi dan nilai-nilai budaya yang mendalam, mencerminkan kearifan lokal masyarakat Aceh.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="py-20 px-6 bg-white relative overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto relative z-10">
            ...
            >
              ...
              <div className="aspect-video rounded-lg overflow-hidden border-4 border-[#d4af37]/20 relative">
                <iframe
                ...
                ></iframe>
                <div className="absolute top-0 left-0 w-20 h-20 bg-[url('/patterns/aceh-corner-flipped.png')] bg-no-repeat bg-contain opacity-30"></div>
                <div className="absolute bottom-0 right-0 w-20 h-20 bg-[url('/patterns/aceh-corner.png')] bg-no-repeat bg-contain opacity-30"></div>
              </div>
            </motion.div>
            ...
            >
              <Button
                className="bg-[#0c4a34] hover:bg-[#0a3e2c] text-white relative overflow-hidden group"
              ...
              >
                ...
                <span className="absolute inset-0 bg-[url('/patterns/aceh-button-pattern.png')] bg-repeat opacity-0 group-hover:opacity-20 transition-opacity"></span>
              </Button>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-20 px-6 bg-[#0c4a34] text-white relative overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto relative z-10">
            ...
            >
              {submitted ? (
                <div className="text-center p-8 bg-white/10 rounded-lg relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-20 h-20 bg-[url('/patterns/aceh-corner.png')] bg-no-repeat bg-contain opacity-20"></div>
                  <div className="absolute bottom-0 left-0 w-20 h-20 bg-[url('/patterns/aceh-corner-flipped.png')] bg-no-repeat bg-contain opacity-20"></div>
                  <div className="relative z-10">
                    <motion.div
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
                ...
                <form onSubmit={handleSubmit} className="bg-white/10 rounded-lg p-6 relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-20 h-20 bg-[url('/patterns/aceh-corner.png')] bg-no-repeat bg-contain opacity-20"></div>
                  <div className="absolute bottom-0 left-0 w-20 h-20 bg-[url('/patterns/aceh-corner-flipped.png')] bg-no-repeat bg-contain opacity-20"></div>
                  <div className="relative z-10">
                    <div className="mb-4">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex gap-4">
                        <Button
                          ...
                          className={
                            rsvpStatus === "hadir"
                              ? "bg-[#d4af37] text-[#0c4a34] hover:bg-[#c9a633] border-[#d4af37] relative overflow-hidden group"
                              : "border-white/20 text-white hover:bg-white/10 hover:text-white"
                          }
                          onClick={() => setRsvpStatus("hadir")}
                        >
                          <span className="relative z-10">Ya, Saya Akan Hadir</span>
                          <span className="absolute inset-0 bg-[url('/patterns/aceh-button-pattern.png')] bg-repeat opacity-0 group-hover:opacity-20 transition-opacity"></span>
                        </Button>
                        <Button
                          type="button"
                        ...
                        >
                          <span className="relative z-10">Maaf, Tidak Bisa Hadir</span>
                          <span className="absolute inset-0 bg-[url('/patterns/aceh-button-pattern.png')] bg-repeat opacity-0 group-hover:opacity-20 transition-opacity"></span>
                        </Button>
                      </div>
                    </div>
                    ...
                    <Button
                      type="submit"
                      className="w-full bg-[#d4af37] text-[#0c4a34] hover:bg-[#c9a633] relative overflow-hidden group"
                    >
                      <span className="relative z-10 flex items-center">
              ...
              <div className="mt-12">
                <Button
                  variant="outline"
                  className="w-full border-white/20 text-white hover:bg-white/10 hover:text-white relative overflow-hidden group"
                ...
                {showRsvpList && (
                  <motion.div
                    ...
                    className="mt-4 bg-white/10 rounded-lg p-6 overflow-hidden relative"
                  >
                    <div className="absolute top-0 right-0 w-20 h-20 bg-[url('/patterns/aceh-corner.png')] bg-no-repeat bg-contain opacity-20"></div>
                    <div className="relative z-10">
        ...
        {/* Footer */}
        <footer className="py-12 px-6 bg-[#0a3e2c] text-white/80 text-center relative overflow-hidden">
          <div className="absolute inset-0 bg-[url('/patterns/aceh-background-pattern.png')] opacity-5"></div>
          <div className="max-w-3xl mx-auto relative z-10">
            <div className="mb-6">
